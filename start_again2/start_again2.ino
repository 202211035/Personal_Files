...
void robot_line_trace(void)
{
  ...
  {
    case -4:
            motor_control_r(1, 80); //속도 제어할 것
            motor_control_l(-1, 30);
            break;
    
    case -3:
            motor_control_r(1, 75);
    ...
    case 3:
            ...
            motor_control_l(1, 75);
            break;
    
    case 4:
            motor_control_r(-1, 30);
            motor_control_l(1, 80);
            break;
...
void loop()
{
  ...
  {
    motor_control_r(1, 100);
    motor_control_l(1, 100); //좌우 속도 맞추기
  }
}
